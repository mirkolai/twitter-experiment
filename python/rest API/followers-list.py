...
for screen_name in screen_names:
    ...
    while next_cursor!=0:
        try:
            ...
            if next_cursor<0:
                timeline_endpoint = "https://api.twitter.com/1.1/followers/ids.json?count=5000&cursor=-1&screen_name=" + screen_name

            else:
                timeline_endpoint = "https://api.twitter.com/1.1/followers/ids.json?count=5000&cursor=" + str(next_cursor) +"&screen_name=" + screen_name
